...
public class Creature {
	...
	public void moveBy(int mx, int my, int mz){
		...
		otherActionForMove(mx, my, mz, tile);
	}

	private void otherActionForMove(int mx, int my, int mz, Tile tile) {
	...
	public void equip(Item item){
		...
		equipItemWithStats(item);
	}

	private void equipItemWithStats(Item item) {
